      ...
      <ul>
        <li v-for="(item, index) in goods" :key="index" class="menu-item" :class="{'current':currentIndex === index}"
          ...
          <span class="text"><span v-show="item.type > 0" class="icon"
                                   :class="classMap[index]"></span>{{item.name}}</span>
        </li>
      </ul>
    </div>
    ...
    .menu-wrapper {
      ...
      .menu-item {
        ...
        .icon {
          ...
          &.decrease {
            .goods-bg-image('decrease_3');
          }
          &.discount {
            .goods-bg-image('discount_3');
          }
          &.invoice {
            .goods-bg-image('invoice_3');
          }
          &.special {
            .goods-bg-image('special_3');
          }
          &.guarantee {
            .goods-bg-image('guarantee_3');
          }
        }
        .text {
          display: table-cell;
