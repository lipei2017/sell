    ...
    <div class="food" v-show="showFlag" ref="food">
      <div class="food-content">
        ...
        <div class="rating">
          ...
          <rating-select :select-type="selectType" :onlyContent="onlyContent" :desc="desc"
                         :ratings="food.ratings" @ratingTypeSelect="ratingTypeSelect" @contentToggle="contentToggle"></rating-select>
  ...
  export default {
    ...
    methods: {
      ...
      addFirst(event) {
        ...
        this.$root.Bus.$emit('cartAdd', event.target);
      },
